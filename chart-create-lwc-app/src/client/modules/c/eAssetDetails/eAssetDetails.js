...
export default class EAssetDetails extends LightningElement {
    ...
    details_label = {
        DCX_Asset_Search_All_Asset_Details:
            'DCX_Asset_Search_All_Asset_Details',
        ...
        DCX_AssetGrid_AddAsset_navigationItem_Identification:
            'DCX_AssetGrid_AddAsset_navigationItem_Identification',
        DCX_AssetGrid_AddAsset_navigationItem_Configuration:
            'DCX_AssetGrid_AddAsset_navigationItem_Configuration',
        DCX_AssetGrid_AddAsset_Field_Installed_Options:
            'DCX_AssetGrid_AddAsset_Field_Installed_Options',
        DCX_Asset_Latest_Firmware_Software:
            'DCX_Asset_Latest_Firmware_Software',
        DCX_AssetGrid_Column_Installed_Licenses:
            'DCX_AssetGrid_Column_Installed_Licenses',
        DCX_Asset_Coverage: 'DCX_Asset_Coverage',
        dcx_Agreements: 'dcx_Agreements',
        DCX_Asset_Coverage: 'DCX_Asset_Coverage',
        DCX_AssetGrid_AddAsset_navigationItem_Service:
            'DCX_AssetGrid_AddAsset_navigationItem_Service',
        DCX_AssetGrid_Open_Service_Orders: 'DCX_AssetGrid_Open_Service_Orders',
        DCX_SupportGrid_History: 'DCX_SupportGrid_History',
        DCX_AssetGrid_AddAsset_navigationItem_Service_History:
            'DCX_AssetGrid_AddAsset_navigationItem_Service_History',
        DCX_ProductLifeCycle_ServiceNotes: 'DCX_ProductLifeCycle_ServiceNotes',
        DCX_AssetGrid_Notes: 'DCX_AssetGrid_Notes',
        DCX_No_Applicable_Service_Notes_Found:
            'DCX_No_Applicable_Service_Notes_Found',
        DCX_AssetGrid_AddAsset_navigationItem_Lifecycle:
            'DCX_AssetGrid_AddAsset_navigationItem_Lifecycle',
        DCX_AssetGrid_AddAsset_navigationItem_Ordering:
            'DCX_AssetGrid_AddAsset_navigationItem_Ordering',
        DCX_AssetGrid_AddAsset_navigationItem_Inventory:
            'DCX_AssetGrid_AddAsset_navigationItem_Inventory',
